...
- [x] README com setup e decisões do projeto - inclui seção "fora do escopo"
- [x] Lista de endpoints da API - com o status HTTP de cada situação de erro
...
- [x] CI rodando testes, phpstan e build das imagens - GitHub Actions em três jobs
